...
![Project Kit Coming Soon](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/kit.jpg)
...
![step1](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step1.jpg)

2) Take one of the wires and plug it into ground of the lcd screen and ground of the arduino.

![step2](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step2.jpg)

3) Take one of the wires and plug it into vcc of the lcd screen and 5v of the arduino.

![step3](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step3.jpg)

4) Take one of the wires and plug it into sda of the lcd screen and A4 of the arduino.

![step4](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step4.jpg)

5) Take one of the wires and plug it into scl of the lcd screen and A5 of the arduino.

![step5](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step5.jpg)

6) Take the arduino and plug it into the computer.

![step6](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step6.jpg)

7) Drag the Big Lcd Block onto the screen.

![step7](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step7a.png)
![step8](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step7b.png)

8) Type something into each text block.

![step8](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step8.png)

9) Upload the code to the arduino.

![step9](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step9a.png)

![step9](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step9b.jpg)
...
![step10](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step10a.png)

![step10](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step10b.png)

11) Drag the delay block onto the screen and connect it to the Back Light block.

![step11](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step11a.png)

![step11](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step11b.png)

12) Drag another back light block and connect it to the delay block and set it off.

![step12](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step12.png)

13) Drag another delay block and connect it to the bottom of the blocks.

![step13](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step13.png)

14) Upload the code the arduino.  You should see the back light turn on and off every second.

![step14](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step14a.png)
![step14](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step14b.jpg)
![step14](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step14c.jpg)
...
![lcd](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/lcd-grid-numbered.png)

To specify a point you put in the x axis then the y axis. For example the red point would be (1, 3).  


![lcd](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/lcd-grid-marked.png)
...
![step15](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step15a.png)

![step15](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step15b.png)
...
![step16](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step16a.png)
![step16](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step16b.png)

17) Drag the print block and connect it to the set position block.

![step17](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step17a.png)
![step17](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step17b.png)

18) Drag the text block onto the screen and hook it into the lcd print block.  
 
![step18](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step18a.png)
![step18](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step18b.png)

19) Type Hello World into the text block.

![step19](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step19.png)

20) Upload the code to the arduino.

![step20](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step20a.png)
![step20](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step20b.jpg)
...
![step20](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step21.png)

22) Drag the clear block on screen.  This block will make the screen blank.

![step22](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step22a.png)
![step22](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step22b.png)

23) Drag the delay block and connect it to the clear block.  Then put 5000 into the delay block.

![step23](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step23.png)

24) Upload the arduino code.  Notice that after 5 second hello world goes away.  Then it appears 5 seconds later.

![step24](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step24a.png)
![step24](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step24b.jpg)
![step24](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step24c.jpg)
...
![step25](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step25a.png)
![step25](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step25b.png)


26) Drag the debug block inside the count loop block.  The Debug Block will pause the program and print the variables
 to logout.

![step26](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step26a.png)
![step26](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step26b.png)

27) Now click the reset button and upload a blank sketch to the arduino.  This is clear out any old code in the arduino.

![step27](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step27.png)

28) Once it has successfully loaded, upload the code to the arduino.

![step28](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step28a.png)

29) Open the Logging \ Debugging window and notice the debug block is black and high lighted.

![step29](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step29a.png)
...
![step30](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step30.png)

31) Click the continue block and notice the value for i changed to 2.  Continue to click the continue block until i 
equals 10.

![step31](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step31.png)
...
![lcd you rock start](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/lcd-you-rock-start.png)

![lcd you rock end](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/lcd-you-rock-end.png)
...
![step32](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step32.png)

33) Drag the right scroll block inside the loop.

![step33](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step33a.png)

![step33](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step33b.png)

34) Drag the delay block inside the for loop.

![step34](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step34.png)

35) Upload the code the arduino and watch the words scroll on the screen.

![step35](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step35a.png)
![step35](/learnaustintech/images/arduino-block/2017-10-25-arduino-lcd/step35.gif)
